...
import edu.hku.sdb.parse.HiveLexer;
import edu.hku.sdb.parse.HiveParser;
import edu.hku.sdb.parse.HiveParser_SelectClauseParser;
...
public class ParseDriver {
  ...
  // opposed to
  // combination of upper case and lower case characteres. This is purely used
  ...
  /*
   * parse a String as a Select List. This allows table functions to be passed
   * expression Strings that are translated in the context they define at
   * invocation time. Currently used by NPath to allow users to specify what
   * output they want. NPath allows expressions n 'tpath' a column that
   * represents the matched set of rows. This column doesn't exist in the input
   * schema and hence the Result Expression cannot be analyzed by the regular
   * Hive translation process.
   */
