...
atomExpression
    ...
    | intervalOrIntervalProp
    | intervalDistance
    ;

intervalOrIntervalProp
	:
	tableOrColumn DOT KW_INTERVAL (prop=DOT identifier)?
...
intervalConstant
	:
	LSQUARE intervalCoor COMMA intervalSta COMMA intervalEnd (COMMA intervalStr)? RSQUARE
	-> ^(TOK_INTERVALCONSTANT intervalCoor intervalSta intervalEnd intervalStr?)
	;
...
locationComparator
	:
	KW_IS KW_BEFORE -> TOK_ISBEFORE
	| KW_IS KW_AFTER -> TOK_ISAFTER
	| KW_IS KW_ADJACENT KW_TO -> TOK_ISADJACENTTO
	| KW_IS KW_CORRESPONDING KW_TO -> TOK_ISCORRESPONDINGTO
	| KW_OVERLAPS KW_WITH -> TOK_OVERLAPSWITH
	| KW_CONTAINS -> TOK_CONTAINS
	| KW_IS KW_WITHIN -> TOK_ISWITHIN
	| KW_IS KW_PREFIX KW_OF -> TOK_ISPREFIXOF
	| KW_IS KW_SUFFIX KW_OF -> TOK_ISSUFFIXOF
	| KW_IS KW_UPSTREAM KW_OF -> TOK_ISUPSTREAMOF
	| KW_IS KW_DOWNSTREAM KW_OF -> TOK_ISDOWNSTREAMOF
